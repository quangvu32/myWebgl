...
// document.querySelector('h3').innerHTML = 'Bresenham Algorithm'

// count = 0;
// document.getElementById('toggleButton').addEventListener('click', () => {
//     count += 1;
//     if(count % 2 == 0){
//         document.querySelector('h3').innerHTML = 'Show DDA';
//     }
//     else{
//         document.querySelector('h3').innerHTML = 'Show Bresenham';
//     }
// })
const test = () => {
    // Canvas Setup
    ...
    function Bresenham(context, width, height) {
    ...
    const painter = new Bresenham(context, width, height);
    ...
    canvas.addEventListener('mousedown', (e) => {
        ...
        canvas.addEventListener('mouseup', function onMouseUp(event) {
            canvas.removeEventListener('mousemove', handleMouseMove); // Remove the temporary mousemove listener
